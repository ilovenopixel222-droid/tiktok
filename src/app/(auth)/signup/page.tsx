  ...
  return (
    <Card className="p-8">
      ...
      <p className="mt-2 text-center text-sm text-muted">
        Start generating viral clips in minutes
      </p>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <label className="flex items-start gap-2 text-xs text-muted cursor-pointer">
          <input type="checkbox" className="mt-0.5 rounded border-white/20 bg-white/5" />
          <span>
            I agree to the{" "}
            <a href="#" className="text-primary-light hover:underline">Terms of Service</a>
            {" "}and{" "}
            <a href="#" className="text-primary-light hover:underline">Privacy Policy</a>
          </span>
        </label>
        <Link href="/dashboard">
          <Button className="w-full mt-2" size="lg" glow>
            Create Account
